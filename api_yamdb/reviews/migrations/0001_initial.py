# Generated by Django 2.2.16 on 2022-11-20 17:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(0, 'Оценка не может быть меньше 0'), django.core.validators.MaxValueValidator(10, 'Оценка происходит по 10-ти бальной шкале')])),
